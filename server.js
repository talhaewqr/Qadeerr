...
const CHANNEL_JIDS = process.env.CHANNEL_JIDS ? process.env.CHANNEL_JIDS.split(',') : [
    ...
    "120363427757257320@newsletter",
    "120363405959472145@newsletter",
...
const OWNER_NAME = process.env.OWNER_NAME || "QadeerXTech";

const MENU_IMAGE_URL = process.env.MENU_IMAGE_URL || "https://files.catbox.moe/6dhr11.jpg";
...
const AUTO_STATUS_MSG = process.env.AUTO_STATUS_MSG || "YOUR STATUS HAS BEEN SEEN BY QADEER-XD - XD 🫶🏻";
const DEV = process.env.DEV || 'QadeerXTech';
...
👤 Owner: *${OWNER_NAME}*`;
                ...
                await conn.sendMessage(from, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            title: "⚡ QADEER-XD MINI Speed Test",
            ...
            case 'qadeer':
                ...
                await conn.sendMessage(from, {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        externalAdReply: {
                            title: "📃 QADEER-XD MINI Command Menu",
...
function gracefulShutdown() {
  ...
  isShuttingDown = true;
  console.log("\n🛑 Shutting down QADEER-XD - MINI server...");
